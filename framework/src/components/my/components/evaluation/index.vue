<template>
	<div id="evaluation">
		...
		<div class="list2">
			<div>
				<div class="fruit">
						<img src="../../../../assets/my/1.gif">
					<div>
						<p class="p1">红心柚子水果新鲜包邮</p>
						<p class="p2">买5斤送5斤</p>
						<p class="p3"><span>￥</span><span>25</span></p>
					</div>
				</div>
				<p class="bottom"><span>共2件</span><button><router-link to="/settled">查看订单</router-link></button><router-link :to="{name:'paid'}"><button>评价</button></router-link></p>
			</div>
			
			<div>
				<div class="fruit">
						<img src="../../../../assets/my/2.gif">
					<div>
						<p class="p1">正宗火龙果 超值实惠</p>
						<p class="p2">买10斤送5斤</p>
			...
			<div>
				<div class="fruit">
						<img src="../../../../assets/my/3.gif">
					<div>
						<p class="p1">新鲜水果之王榴莲 好货不等人</p>
						<p class="p2">买10斤送纪念品</p>
